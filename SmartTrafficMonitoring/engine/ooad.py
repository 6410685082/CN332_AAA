...
from engine.experload import attempt_load
from engine.datasets import LoadStreams, LoadImages
from engine.general import check_img_size, check_requirements, \
    check_imshow, non_max_suppression, apply_classifier, \
    scale_coords, xyxy2xywh, strip_optimizer, set_logging, \
    increment_path
from engine.plots import plot_one_box
from engine.torch_utils import select_device, load_classifier, \
    time_synchronized, TracedModel
from engine.download_weights import download
...
from engine.models import LoopInfo, BoxInfo
from pathlib import Path
...
class Vehicle:
    ...
    def detect(save_img=False):
        ...
        # .........................
        # Directories
        save_dir = "/media/"  # increment run
        save_path = Path(save_dir) / 'labels' if save_txt else Path(save_dir)
...
if __name__ == '__main__':
    ...
    loops = [Loop(data) for data in count_boxes.loopinfo]
